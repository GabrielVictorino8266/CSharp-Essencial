    ...
    public partial class frmPrincipal : Form
    {
        ...
        private void btnSomar_Click(object sender, EventArgs e)
        {
            ...
            if (primeiraOperacao) {
                ...
                //Se o botão igual não for pressionado.
                if (botaoIgual == false)
                {
                ...
                txtVisor.Clear();
                //Define o tipo de operação para a variavel operacao
                operacao = "+";
                primeiraOperacao = false;
            }
            else
            {//Não será a primeira operação, então:
                valorVisor = Convert.ToDouble(txtVisor.Text);

                //Indica no histórico a operação:
        ...
        {
            //Switch Case para verificar a operação
            switch (operacao) { 
            case "+":
